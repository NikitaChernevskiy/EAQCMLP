...
generate_dataset('csvs/100.csv', 101)
generate_dataset('csvs/200.csv', 201)
generate_dataset('csvs/300.csv', 301)
generate_dataset('csvs/400.csv', 401)
generate_dataset('csvs/500.csv', 501)
generate_dataset('csvs/600.csv', 601)
generate_dataset('csvs/700.csv', 701)
generate_dataset('csvs/800.csv', 801)
generate_dataset('csvs/900.csv', 901)
generate_dataset('csvs/1000.csv', 1001)
